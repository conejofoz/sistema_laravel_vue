              ...
              <div class="form-group row">
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" v-model="buscar" @keyup.enter="listarVenta(1,buscar,criterio)" placeholder="Texto a buscar">
  ...
  methods: {
    ...
    desactivarVenta(id) {
      ...
      swalWithBootstrapButtons
        .fire({
          title: "Esta seguro de desactivar este venta?",
